...
export function BookingModal({ open, onOpenChange, services }: { open: boolean; onOpenChange: (value: boolean) => void; services: BookingService[] }) {
  ...
  return (
    <Dialog open={open} onOpenChange={close}>
      <DialogContent className="nr-booking-modal max-h-[88vh] overflow-y-auto border-[#EFB7C6] bg-[#FFF8FA] p-0 text-[#351826] shadow-[0_24px_70px_rgba(53,24,38,.24)] sm:max-w-xl" showCloseButton={false}>
        <div className="nr-booking-header bg-[#351826] px-6 py-6 text-[#FFDBDB]">
          <DialogHeader>
        ...
        <div className="nr-booking-content p-6">
